...
- **If a step fails:** Commit partial work with `step X.Y: [description] - incomplete` and document blocker
...
| max_length | 4096 | 8192 | KV cache, config |
